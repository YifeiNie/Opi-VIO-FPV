...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    ...
    DEF_TIM(TIM2,  CH2, PB3,  TIM_USE_MOTOR, 0, 2, 0),   // S3  
    DEF_TIM(TIM2,  CH3, PB10,  TIM_USE_MOTOR, 0, 3, 0),   // S4
    DEF_TIM(TIM2,  CH1, PA0,  TIM_USE_MOTOR, 0, 4, 0),   // S5
    DEF_TIM(TIM2,  CH4, PA3,  TIM_USE_MOTOR, 0, 5, 0),   // S6

    DEF_TIM(TIM8,  CH3, PC8, TIM_USE_MOTOR, 0, 6, 0),   // S7
    DEF_TIM(TIM8,  CH4, PC9, TIM_USE_MOTOR, 0, 7, 0),   // S8
