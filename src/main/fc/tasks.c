...
task_attribute_t task_attributes[TASK_COUNT] = {
...
#ifdef USE_TELEMETRY
    [TASK_TELEMETRY] = DEFINE_TASK("TELEMETRY", NULL, NULL, taskTelemetry, TASK_PERIOD_HZ(60), TASK_PRIORITY_LOW),
#endif
  ...
  //  [TASK_KALMAN_FILTER] = DEFINE_TASK("TASK_KALMAN_FILTER", NULL, NULL, Update_Kalman_filter, TASK_PERIOD_HZ(400), TASK_PRIORITY_LOW),
    //[TASK_ALT_CTRL] = DEFINE_TASK("TASK_ALT_CTRL", NULL, NULL, Update_PID_Position, TASK_PERIOD_HZ(150), TASK_PRIORITY_LOW),
    [TASK_ANGLE_CTRL] = DEFINE_TASK("TASK_ANGLE_CTRL", NULL, NULL, Updata_Angle_or_Anglerate, TASK_PERIOD_HZ(120), TASK_PRIORITY_LOW),
