...
- 使用命令 wget http://fishros.com/install -O fishros && . fishros 安装ROS会方便很多，我安装的是ROS2
- 先后在两个终端分别使用 ros2 run turtlesim turtlesim_node 和 ros2 run turtlesim turtlesim_node 命令测试ROS2的安装，具体为方向键控制一个小乌龟
- 先后使用udo apt-get install ros-jazzy-mavros 和 sudo apt-get install ros-jazzy-mavros-extras安装MavROS工具，妻子jazzy是我安装的ROS2的版本EGO 
- 
- 
